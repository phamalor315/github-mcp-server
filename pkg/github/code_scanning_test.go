...
func Test_GetCodeScanningAlert(t *testing.T) {
	...
	tool, _ := GetCodeScanningAlert(func(_ context.Context) (*github.Client, error) { return mockClient, nil }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			...
			_, handler := GetCodeScanningAlert(func(_ context.Context) (*github.Client, error) { return client, nil }, translations.NullTranslationHelper)
...
func Test_ListCodeScanningAlerts(t *testing.T) {
	// Verify tool definition once
	mockClient := github.NewClient(nil)
	tool, _ := ListCodeScanningAlerts(func(_ context.Context) (*github.Client, error) { return mockClient, nil }, translations.NullTranslationHelper)
	...
	for _, tc := range tests {
		t.Run(tc.name, func(t *testing.T) {
			// Setup client with mock
			client := github.NewClient(tc.mockedClient)
			_, handler := ListCodeScanningAlerts(func(_ context.Context) (*github.Client, error) { return client, nil }, translations.NullTranslationHelper)
